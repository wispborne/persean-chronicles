    ...
    pages = listOf(
        Page(
            ...
            onPageShown = {
                ...
                addPara {
                    "\"Look lively, boys!\" Charengo is the only person still standing. \"Your chariot awaits!\" " +
                            "In short order, he double-checks the jetpacks on the backs of each of the men, or \"Dragonriders\", " +
                            "as they creatively branded themselves during their first night of the voyage. Charengo opens the side " +
            ...
            onPageShown = {
                addPara {
                    "The dragons of ${planetName()} you saw as a kid were different from the dragons of mythology, " +
                            ...
                            "had been drugged to make them easier to film. A quick survey of the scene shows that Charengo has tagged three " +
            ...
            onPageShown = {
                ...
                addPara {
                    "The defeated Dragonriders need no further encouragement. They beeline for the hatch and you drop " +
                            ...
                            "Charengo isn't with them. You turn to ask about him, when a flicker of motion on a monitor catches your eye."
                }
                addPara {
                    "Charengo is there, and he's riding a dragon, gripping the ridge of scales around its neck. " +
            ...
            onPageShown = {
                addPara {
                    "The ship takes off quickly enough to make you temporarily light-headed. " +
                            "\"GET ON!\" shouts one of the men over the PA as you position the ship just below the raging dragon with Charengo attached." +
