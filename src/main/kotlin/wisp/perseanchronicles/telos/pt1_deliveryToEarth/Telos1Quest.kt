...
//
//object Telos1Quest : AutoQuestFacilitator(
...
//        }),
//    autoIntelInfo =
//    AutoIntelInfo(Telos1Intel::class.java) {
//        Telos1Intel(startLocation = Telos1Quest.state.startLocation, endLocation = Telos1Quest.state.karengoPlanet)
//    }
//) {
...
//        for (fleet in Global.getSector().hyperspace.fleets) {
//            if (fleet.memory.keys.contains("")) fleet.despawn(); fleet.id
//        }
...
//            .pickPlanet()
//            ?: kotlin.run { game.logger.w { "Unable to find a planet for Telos pt 1." }; return }
//
//        (state.karengoSystem ?: return).let { system ->
